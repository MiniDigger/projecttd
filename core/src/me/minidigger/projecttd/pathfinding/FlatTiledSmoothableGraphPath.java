 ...
 * @author davebaol
 */
public class FlatTiledSmoothableGraphPath extends DefaultGraphPath<FlatTiledNode> implements
        SmoothableGraphPath<FlatTiledNode, Vector2> {
    ...
    public Vector2 getNodePosition(int index) {
        FlatTiledNode node = nodes.get(index);
